...
typedef enum
{
    MCP23017_IODIRA_COMMAND_OUTPUT      = 0x00,
    MCP23017_IODIRB_COMMAND_INPUT       = 0x7F,
    MCP23017_GPPUB_COMMAND_PULL_UP      = 0x7F,
    MCP23017_IPOLB_COMMAND_INVERT_INPUT = 0x7F,
} MCP23017_COMMANDS;
...
static bool WriteMCP23017(uint8_t registerAddress, uint8_t data);
static uint8_t ReadMCP23017(uint8_t registerAddress);

void InitMCP23017Peripherals(void)
{
...
{
    WriteMCP23017(MCP23017_ADDRESS_IODIRA, MCP23017_IODIRA_COMMAND_OUTPUT);      // Set PORTA to outputs
    WriteMCP23017(MCP23017_ADDRESS_IODIRB, MCP23017_IODIRB_COMMAND_INPUT);       // Set PORTB to inputs
    WriteMCP23017(MCP23017_ADDRESS_GPPUB,  MCP23017_GPPUB_COMMAND_PULL_UP);      // Set PORTB pull-ups (100k)
    WriteMCP23017(MCP23017_ADDRESS_IPOLB,  MCP23017_IPOLB_COMMAND_INVERT_INPUT); // Invert PORTB input readings
}
